 ...
 */
void main() {
    vec4 vfs = vec4(0.0,0.0,0.0,1.0) ;

    /*if ((pixPos.x-0.5)*(pixPos.x-0.5) + (pixPos.y-0.5)*(pixPos.y-0.5) < 0.008 || (pixPos.x-0.5)*(pixPos.x-0.5) + (pixPos.y-0.5)*(pixPos.y-0.5) > 0.045 && (pixPos.x-0.5)*(pixPos.x-0.5) + (pixPos.y-0.5)*(pixPos.y-0.5) < 0.055 ){
        vfs.r = 3.0 ;
        vfs.g = 3.0 ;
    }*/
